...
const IDefinition_1 = require("./definition/IDefinition");
...
class APIDefintion {
    ...
    parse(definition) {
        ...
        definition.api.routes.forEach(function (elem) {
            this._routes.push(IDefinition_1.buildRoute(elem));
        }, this);
    ...
    preprocess() {
        ...
        this._routes.forEach(function (elem) {
            elem.formatText();
        });
